...
const PartnerCount = () => {
  ...
  return (
    <div className="h-screen flex justify-center items-center text-center bg-blac  w-full">
      <div className="flex items-stretch justify-center itms-center  flex-col ">
        <motion.span
          style={{ color: textColor }}
          className="text-[230px] leading-[230px]  font-bold "
        >
          75lacs+
        </motion.span>
        <h1 className="text-black font-bold text-[68px]">Forward-thinking partner</h1>
      </div>
    </div>
  );
};
